package com.example.kindastoreapi.models;
...
public class ModelM implements Parcelable, Serializable {
    ...
    public ModelM(int modelId, String modelTitle, String modelCategory, String modelDescription, Double modelPrice, String modelImage) {
